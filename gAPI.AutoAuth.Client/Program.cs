...
//#endif
    ...
    public void ShowError(string errorMessage, SourceProductionContext CurrentSpc)
    {
        ...
        var sourceCode = $"#error gAPI.AutoAuth.Client: {errorMessage.Replace("\r", "").Replace("\n", " ")}";
        CurrentSpc.AddSource("Gapi_Error.AutoAuth.Client.g.cs", SourceText.From(sourceCode, Encoding.UTF8));
    }
