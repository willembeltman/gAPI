...
{
    public static PageConfig Parse(string json)
    {
        return new PageConfig
        {
            BaseNamespaces = ParseStringList(json, nameof(PageConfig.BaseNamespaces)),
            Pages_Destination = ParseBlock(json, nameof(PageConfig.Pages_Destination)),
            Components_Destination = ParseBlock(json, nameof(PageConfig.Components_Destination)),
            Layout_Destination = ParseBlock(json, nameof(PageConfig.Layout_Destination)),
        };
    }
