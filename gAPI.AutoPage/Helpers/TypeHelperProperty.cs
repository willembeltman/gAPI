...
namespace gAPI.AutoPage.Helpers;
...
public class TypeHelperProperty : ITypeHelperProperty
{
    public TypeHelperProperty(ServiceContext serviceContext, TypeHelper parentTypeHelper, IPropertySymbol propertySymbol, ITypeSymbol[] history)
    {
        ...
        PropertyType = new TypeHelper(serviceContext, PropertyTypeSymbol, IsNullable, history);
    }
    ...
    public TypeHelper PropertyType { get; }
    ...
    ITypeHelper ITypeHelperProperty.Type => PropertyType;
}
