        ...
        public void Initialize(IncrementalGeneratorInitializationContext context)
        {
            try
            {
                var configFile = context.AdditionalTextsProvider
                    .Where(file => Path.GetFileName(file.Path).Equals("gapi.autoservice.json", StringComparison.OrdinalIgnoreCase))
...
//#endif
                    ...
                    var apisGenerator = new ServicesGenerator(dataModel, spc);
