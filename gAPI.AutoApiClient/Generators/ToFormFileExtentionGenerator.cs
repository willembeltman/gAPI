...
public class IsFormFileExtentionGenerator : BaseGenerator
{
    private readonly ClientConfig config;

    public IsFormFileExtentionGenerator(ClientConfig config)
    {
        this.config = config;
...
{{
    [IsFormFileExtention]
    public static class IsFormFileExtention
    {{
