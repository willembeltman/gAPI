...
namespace gAPI.AutoMapperOld
{
    public static class Mapper
    {
        ...
        public static async Task<TDto> ToDtoAsync<TEntity, TDto>(this TEntity? entity, TDto? dto)
            where TEntity : class
            where TDto : class
        {
            if (entity == null)
            ...
            {
                var customResult = await customMapper.ToDtoAsync(entity, dto, defaultMapper);
            ...
            try
            {
                ...
                else
                {
                    var customProjection = customMapper
                        .ProjectToDtosAsync(entities, orderby, skip, take, defaultMapper);
