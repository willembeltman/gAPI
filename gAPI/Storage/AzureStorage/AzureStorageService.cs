...
namespace gAPI.Storage.AzureStorage
{
    ...
    public class AzureStorageService : IStorageService
    {
        ...
        public async Task<string?> GetStorageFileUrlAsync(string id, string type)
        {
            ...
            return await GetStorageFileUrlAsync(containerClient, blobName);
        }
        ...
        public async Task<string?> GetStorageFileUrlAsync(BlobContainerClient containerClient, string blobName)
        {
        ...
        public async Task<string?> SaveStorageFileAsync(IStorageFile storageFile, string fileName, string mimeType, Stream stream, bool allowOverwrite = true)
        {
            ...
            var response = await blobClient.UploadAsync(stream, uploadOptions, cancellationToken: default);

            // Genereer URL voor direct gebruik
            return await GetStorageFileUrlAsync(storageFile);
        }
