...
public class AddAutoWssServerServicesExtensionGenerator : _BaseGenerator
{
    public AddAutoWssServerServicesExtensionGenerator(
        Generator context)
    {
        Context = context;

        Name = "AddAutoWssServerServicesExtension";
