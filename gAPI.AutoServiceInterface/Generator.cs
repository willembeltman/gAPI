        ...
        public void Initialize(IncrementalGeneratorInitializationContext context)
        {
            try
            {
                var configFile = context.AdditionalTextsProvider
                    .Where(file => Path.GetFileName(file.Path).Equals("gapi.autoserviceinterface.json", StringComparison.OrdinalIgnoreCase))
...
//#endif
                    ...
                    var apisGenerator = new ServiceInterfacesGenerator(dataModel, spc);
