...
internal static class ComparerFactory<TIn, TOut>
{
    ...
    public static ComparerInstance<TIn, TOut> CreateInstance()
    {
        ...
        var @namespace = "gAPI.Storage.Server.AutoComparer.GeneratedComparers";
...
{{
    ...
    if (!gAPI.Storage.Server.AutoComparer.Comparer.Compare({sourceExpression}, {targetExpression})) return false;
}}";
    }
