...
public static class DbContextExtenderFactory
{
    ...
    public static DbContextExtender CreateInstance(DbContext dbContext)
    {
        ...
        var className = $"{applicationDbContextType.Name}DbContextFactory";
        var extenderMethodNameDirectory = "ExtendDbContextDirectory";

        // Genereer de C# broncode die de extend-methodes definieert
        var Code = GenerateDbSetLoaderCode(applicationDbContextType, className, extenderMethodNameDirectory);
        ...
        var instance = new DbContextExtender(LoadDbSetsFromDirectoryDelegate, Code);
