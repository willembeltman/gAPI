using gAPI.Storage.Server.EntityFrameworkDisk.Models;
using gAPI.Storage.Server.EntityFrameworkDisk.Navigators.Extenders;
using gAPI.Storage.Server.Helpers;

namespace gAPI.Storage.Server.EntityFrameworkDisk.Navigators;

public static class NavigatorFactory<T>
{
    public static Navigator<T> CreateInstance(DbContext dbContext)
    {
        ...
        var instance = new Navigator<T>(ExtendDelegate, FindForeignKeyUsageDelegate, Code);
