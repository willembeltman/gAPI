using gAPI.Storage.Server.AutoComparer;
using gAPI.Storage.Server.AutoSerializer;
using gAPI.Storage.Server.EntityFrameworkDisk.EntityDefinitions;
using gAPI.Storage.Server.EntityFrameworkDisk.IndexSets;
using gAPI.Storage.Server.EntityFrameworkDisk.Interfaces;
using gAPI.Storage.Server.EntityFrameworkDisk.Locks;
using System.Collections;
using System.Linq.Expressions;

namespace gAPI.Storage.Server.EntityFrameworkDisk.DataSets;
...
public class DataSet<T> : IDiskSet<T>
{
    ...
    public DataSet(DirectoryInfo? directory = null)
    {
        ...
        SerializerInstance = Serializer.GetOrCreate<T>();
