# gAPI.Storage.Server.EntityFrameworkDisk
...
Instead of connecting to SQL Server, PostgreSQL, or other database engines, gAPI.Storage.Server.EntityFrameworkDisk stores your data directly as optimized binary files on disk.
...
- gAPI.Storage.Server.AutoSerializer — Runtime-generated, ultra-fast binary serializers for entities.
- gAPI.Storage.Server.AutoComparer — Runtime-generated comparison modules for high-speed dirty state detection.
