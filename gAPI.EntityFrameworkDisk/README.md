...
Instead of connecting to SQL Server, PostgreSQL, or other database engines, gAPI.EntityFrameworkDisk.EntityFrameworkDisk stores your data directly as optimized binary files on disk.
