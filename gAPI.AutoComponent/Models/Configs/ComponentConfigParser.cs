...
public static class ComponentConfigParser
{
    public static ComponentConfig Parse(string json)
    {
        return new ComponentConfig
        {
            BaseNamespaces = ParseStringList(json, nameof(ComponentConfig.BaseNamespaces)),
            Clients_Destination = ParseBlock(json, nameof(ComponentConfig.Clients_Destination)),
            Components_Destination = ParseBlock(json, nameof(ComponentConfig.Components_Destination)),
            Helpers_Destination = ParseBlock(json, nameof(ComponentConfig.Helpers_Destination)),
            Authentication_Destination = ParseBlock(json, nameof(ComponentConfig.Authentication_Destination)),
        };
    }
