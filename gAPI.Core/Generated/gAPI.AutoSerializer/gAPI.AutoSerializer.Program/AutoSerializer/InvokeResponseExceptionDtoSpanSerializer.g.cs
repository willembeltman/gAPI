...
public static class InvokeResponseExceptionDtoSpanSerializer
{
    ...
    public static void Write(this ref Span<byte> ___span, ref int ___offset, InvokeResponseExceptionDto value)
    {
    ...
    public static InvokeResponseExceptionDto ReadInvokeResponseExceptionDto(this ReadOnlySpan<byte> ___span, ref int ___offset)
    {
    ...
    public static int Length(ref int ___offset, InvokeResponseExceptionDto value)
    {
        ___offset += 10;
