...
public static class SendRequestCancelledClientDtoSerializer
{
    ...
    [IsSerializerRead]
    public static SendRequestCancelledClientDto ReadSendRequestCancelledClientDto(this BinaryReader ___reader)
    {
        ...
        return new SendRequestCancelledClientDto(RoutingDtoSerializer.ReadRoutingDto(___reader), ___reader.ReadBoolean(), ___reader.ReadBoolean() == false ? null : ___reader.ReadString(), ___reader.ReadBoolean() == false ? null : ___reader.ReadString());
    }
}