...
public static class SessionIdSerializer
{
    ...
    [IsSerializerWrite]
    public static void Write(this BinaryWriter ___writer, SessionId value)
    {
    ...
    [IsSerializerRead]
    public static SessionId ReadSessionId(this BinaryReader ___reader)
    {
        ...
        return new SessionId(___reader.ReadString());
    }
}