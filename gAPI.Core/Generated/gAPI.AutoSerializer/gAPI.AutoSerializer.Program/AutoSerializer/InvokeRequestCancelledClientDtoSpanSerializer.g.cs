...
public static class InvokeRequestCancelledClientDtoSpanSerializer
{
    ...
    public static void Write(this ref Span<byte> ___span, ref int ___offset, InvokeRequestCancelledClientDto value)
    {
    ...
    public static InvokeRequestCancelledClientDto ReadInvokeRequestCancelledClientDto(this ReadOnlySpan<byte> ___span, ref int ___offset)
    {
        ...
        return new InvokeRequestCancelledClientDto(RoutingDtoSpanSerializer.ReadRoutingDto(___span, ref ___offset), PrimitivesSpanSerializer.ReadBoolean(___span, ref ___offset) == false ? null : PrimitivesSpanSerializer.ReadString(___span, ref ___offset), PrimitivesSpanSerializer.ReadBoolean(___span, ref ___offset), PrimitivesSpanSerializer.ReadBoolean(___span, ref ___offset) == false ? null : PrimitivesSpanSerializer.ReadString(___span, ref ___offset));
    }

    [IsSpanSerializerLength]
    public static int Length(ref int ___offset, InvokeRequestCancelledClientDto value)
    {
        ___offset += 10;
