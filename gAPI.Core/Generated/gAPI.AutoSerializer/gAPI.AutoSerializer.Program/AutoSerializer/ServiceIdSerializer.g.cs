...
public static class ServiceIdSerializer
{
    ...
    [IsSerializerWrite]
    public static void Write(this BinaryWriter ___writer, ServiceId value)
    {
    ...
    [IsSerializerRead]
    public static ServiceId ReadServiceId(this BinaryReader ___reader)
    {
        ...
        return new ServiceId(___reader.ReadString());
    }
}