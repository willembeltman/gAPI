...
public static class SubscribeDtoSpanSerializer
{
    public const ushort Magic = (ushort)0x4741;
    public const uint TypeId = 0x8BEB0804;
    public const uint SchemaHash = 0xAA6F3895;

    [IsSpanSerializerWrite]
    public static void Write(this ref Span<byte> ___span, ref int ___offset, SubscribeDto value)
    {
    ...
    public static SubscribeDto ReadSubscribeDto(this ReadOnlySpan<byte> ___span, ref int ___offset)
    {
        ...
        return new SubscribeDto(
			...
			UserIdSpanSerializer.ReadUserId(___span, ref ___offset), 
			SessionIdSpanSerializer.ReadSessionId(___span, ref ___offset));
    }

    [IsSpanSerializerLength]
    public static int Length(ref int ___offset, SubscribeDto value)
    {
        ___offset += 10;
