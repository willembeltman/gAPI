...
public static class ServiceMethodIdSerializer
{
    ...
    [IsSerializerWrite]
    public static void Write(this BinaryWriter ___writer, ServiceMethodId value)
    {
    ...
    [IsSerializerRead]
    public static ServiceMethodId ReadServiceMethodId(this BinaryReader ___reader)
    {
        ...
        return new ServiceMethodId(___reader.ReadString());
    }
}