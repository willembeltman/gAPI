...
public static class StreamIdSpanSerializer
{
    public const ushort Magic = (ushort)0x4741;
    public const uint TypeId = 0x78C076C0;
    public const uint SchemaHash = 0x37571059;

    [IsSpanSerializerWrite]
    public static void Write(this ref Span<byte> ___span, ref int ___offset, StreamId value)
    {
    ...
    public static StreamId ReadStreamId(this ReadOnlySpan<byte> ___span, ref int ___offset)
    {
        ...
        return new StreamId(PrimitivesSpanSerializer.ReadString(___span, ref ___offset));
    }

    [IsSpanSerializerLength]
    public static int Length(ref int ___offset, StreamId value)
    {
        ___offset += 10;
