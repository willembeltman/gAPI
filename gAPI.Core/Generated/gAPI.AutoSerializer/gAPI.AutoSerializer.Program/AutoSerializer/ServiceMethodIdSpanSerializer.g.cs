...
public static class ServiceMethodIdSpanSerializer
{
    public const ushort Magic = (ushort)0x4741;
    public const uint TypeId = 0xC49E1358;
    public const uint SchemaHash = 0x37571059;

    [IsSpanSerializerWrite]
    public static void Write(this ref Span<byte> ___span, ref int ___offset, ServiceMethodId value)
    {
    ...
    public static ServiceMethodId ReadServiceMethodId(this ReadOnlySpan<byte> ___span, ref int ___offset)
    {
        ...
        return new ServiceMethodId(PrimitivesSpanSerializer.ReadString(___span, ref ___offset));
    }

    [IsSpanSerializerLength]
    public static int Length(ref int ___offset, ServiceMethodId value)
    {
        ___offset += 10;
