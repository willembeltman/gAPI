...
public static class ApiInvokeResponseDtoSpanSerializer
{
    public const ushort Magic = (ushort)0x4741;
    public const uint TypeId = 0x6BEBAAA9;
    public const uint SchemaHash = 0xD7DC0A4F;

    [IsSpanSerializerWrite]
    public static void Write(this ref Span<byte> ___span, ref int ___offset, ApiInvokeResponseDto value)
    {
    ...
    public static ApiInvokeResponseDto ReadApiInvokeResponseDto(this ReadOnlySpan<byte> ___span, ref int ___offset)
    {
        ...
        var value = new ApiInvokeResponseDto();
        ...
        value.SessionData = PrimitivesSpanSerializer.ReadString(___span, ref ___offset);
    ...
    public static int Length(ref int ___offset, ApiInvokeResponseDto value)
    {
        ___offset += 10;
