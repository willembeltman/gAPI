...
public static class StreamingResponseClientDtoSerializer
{
    ...
    [IsSerializerRead]
    public static StreamingResponseClientDto ReadStreamingResponseClientDto(this BinaryReader ___reader)
    {
