...
public static class SendRequestCancelledDtoSerializer
{
    ...
    [IsSerializerWrite]
    public static void Write(this BinaryWriter ___writer, SendRequestCancelledDto value)
    {
    ...
    [IsSerializerRead]
    public static SendRequestCancelledDto ReadSendRequestCancelledDto(this BinaryReader ___reader)
    {
        ...
        return new SendRequestCancelledDto(RoutingDtoSerializer.ReadRoutingDto(___reader), ___reader.ReadBoolean() == false ? null : ___reader.ReadString());
    }
}