...
public static class StreamIdSerializer
{
    ...
    [IsSerializerWrite]
    public static void Write(this BinaryWriter ___writer, StreamId value)
    {
    ...
    [IsSerializerRead]
    public static StreamId ReadStreamId(this BinaryReader ___reader)
    {
        ...
        return new StreamId(___reader.ReadString());
    }
}