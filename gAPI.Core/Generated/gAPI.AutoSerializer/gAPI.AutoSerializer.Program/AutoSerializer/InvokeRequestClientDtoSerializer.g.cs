...
public static class InvokeRequestClientDtoSerializer
{
    ...
    [IsSerializerWrite]
    public static void Write(this BinaryWriter ___writer, InvokeRequestClientDto value)
    {
    ...
    [IsSerializerRead]
    public static InvokeRequestClientDto ReadInvokeRequestClientDto(this BinaryReader ___reader)
    {
