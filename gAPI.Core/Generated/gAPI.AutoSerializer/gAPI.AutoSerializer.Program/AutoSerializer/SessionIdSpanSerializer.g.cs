...
public static class SessionIdSpanSerializer
{
    public const ushort Magic = (ushort)0x4741;
    public const uint TypeId = 0x2139423A;
    public const uint SchemaHash = 0x37571059;

    [IsSpanSerializerWrite]
    public static void Write(this ref Span<byte> ___span, ref int ___offset, SessionId value)
    {
    ...
    public static SessionId ReadSessionId(this ReadOnlySpan<byte> ___span, ref int ___offset)
    {
        ...
        return new SessionId(PrimitivesSpanSerializer.ReadString(___span, ref ___offset));
    }

    [IsSpanSerializerLength]
    public static int Length(ref int ___offset, SessionId value)
    {
        ___offset += 10;
