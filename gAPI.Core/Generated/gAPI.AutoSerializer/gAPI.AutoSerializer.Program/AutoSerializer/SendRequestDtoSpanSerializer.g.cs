...
public static class SendRequestDtoSpanSerializer
{
    ...
    public static SendRequestDto ReadSendRequestDto(this ReadOnlySpan<byte> ___span, ref int ___offset)
    {
    ...
    public static int Length(ref int ___offset, SendRequestDto value)
    {
        ___offset += 10;
