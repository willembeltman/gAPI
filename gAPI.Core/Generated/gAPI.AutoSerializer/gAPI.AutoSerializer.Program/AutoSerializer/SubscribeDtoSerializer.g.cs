...
public static class SubscribeDtoSerializer
{
    ...
    [IsSerializerWrite]
    public static void Write(this BinaryWriter ___writer, SubscribeDto value)
    {
    ...
    [IsSerializerRead]
    public static SubscribeDto ReadSubscribeDto(this BinaryReader ___reader)
    {
        ...
        return new SubscribeDto(ServiceIdSerializer.ReadServiceId(___reader), UserIdSerializer.ReadUserId(___reader), SessionIdSerializer.ReadSessionId(___reader));
    }
}