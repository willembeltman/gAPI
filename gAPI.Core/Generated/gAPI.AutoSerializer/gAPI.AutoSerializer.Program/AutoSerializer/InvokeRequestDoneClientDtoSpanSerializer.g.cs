...
public static class InvokeRequestDoneClientDtoSpanSerializer
{
    ...
    public static void Write(this ref Span<byte> ___span, ref int ___offset, InvokeRequestDoneClientDto value)
    {
    ...
    public static InvokeRequestDoneClientDto ReadInvokeRequestDoneClientDto(this ReadOnlySpan<byte> ___span, ref int ___offset)
    {
