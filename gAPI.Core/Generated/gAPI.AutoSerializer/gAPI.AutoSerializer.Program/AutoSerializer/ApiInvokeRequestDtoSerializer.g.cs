...
public static class ApiInvokeRequestDtoSerializer
{
    ...
    [IsSerializerWrite]
    public static void Write(this BinaryWriter ___writer, ApiInvokeRequestDto value)
    {
    ...
    [IsSerializerRead]
    public static ApiInvokeRequestDto ReadApiInvokeRequestDto(this BinaryReader ___reader)
    {
