...
public static class SendRequestDoneClientDtoSpanSerializer
{
    public const ushort Magic = (ushort)0x4741;
    public const uint TypeId = 0xE41E5930;
    public const uint SchemaHash = 0x5FE36AFB;

    [IsSpanSerializerWrite]
    public static void Write(this ref Span<byte> ___span, ref int ___offset, SendRequestDoneClientDto value)
    {
    ...
    public static SendRequestDoneClientDto ReadSendRequestDoneClientDto(this ReadOnlySpan<byte> ___span, ref int ___offset)
    {
        ...
        return new SendRequestDoneClientDto(RoutingDtoSpanSerializer.ReadRoutingDto(___span, ref ___offset), PrimitivesSpanSerializer.ReadBoolean(___span, ref ___offset), PrimitivesSpanSerializer.ReadBoolean(___span, ref ___offset) == false ? null : PrimitivesSpanSerializer.ReadString(___span, ref ___offset), PrimitivesSpanSerializer.ReadBoolean(___span, ref ___offset), PrimitivesSpanSerializer.ReadBoolean(___span, ref ___offset) == false ? null : PrimitivesSpanSerializer.ReadString(___span, ref ___offset));
    }

    [IsSpanSerializerLength]
    public static int Length(ref int ___offset, SendRequestDoneClientDto value)
    {
        ___offset += 10;
