...
public static class SendArgumentedRequestDoneDtoSerializer
{
    ...
    [IsSerializerWrite]
    public static void Write(this BinaryWriter ___writer, SendArgumentedRequestDoneDto value)
    {
    ...
    [IsSerializerRead]
    public static SendArgumentedRequestDoneDto ReadSendArgumentedRequestDoneDto(this BinaryReader ___reader)
    {
