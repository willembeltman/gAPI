...
public static class ApiInvokeResponseDoneDtoSerializer
{
    ...
    [IsSerializerWrite]
    public static void Write(this BinaryWriter ___writer, ApiInvokeResponseDoneDto value)
    {
        ...
        ___writer.Write(value.SessionData != null); 
        if (value.SessionData != null)
            ___writer.Write(value.SessionData);
    ...
    [IsSerializerRead]
    public static ApiInvokeResponseDoneDto ReadApiInvokeResponseDoneDto(this BinaryReader ___reader)
    {
        ...
        value.SessionData = ___reader.ReadBoolean() == false ? null : ___reader.ReadString();
