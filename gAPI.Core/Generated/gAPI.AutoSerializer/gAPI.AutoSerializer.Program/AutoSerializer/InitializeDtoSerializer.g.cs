...
public static class InitializeDtoSerializer
{
    ...
    [IsSerializerWrite]
    public static void Write(this BinaryWriter ___writer, InitializeDto value)
    {
    ...
    [IsSerializerRead]
    public static InitializeDto ReadInitializeDto(this BinaryReader ___reader)
    {
        ...
        value.SessionId = ___reader.ReadString();
