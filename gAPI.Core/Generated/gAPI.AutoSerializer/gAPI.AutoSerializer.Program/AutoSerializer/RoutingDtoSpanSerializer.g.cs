...
public static class RoutingDtoSpanSerializer
{
    ...
    public static void Write(this ref Span<byte> ___span, ref int ___offset, RoutingDto value)
    {
    ...
    public static RoutingDto ReadRoutingDto(this ReadOnlySpan<byte> ___span, ref int ___offset)
    {
    ...
    public static int Length(ref int ___offset, RoutingDto value)
    {
        ___offset += 10;
