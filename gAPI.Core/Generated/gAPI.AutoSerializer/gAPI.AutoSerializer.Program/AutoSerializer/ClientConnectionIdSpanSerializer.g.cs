...
public static class ClientConnectionIdSpanSerializer
{
    public const ushort Magic = (ushort)0x4741;
    public const uint TypeId = 0xB81CF277;
    public const uint SchemaHash = 0xD11C0D16;

    [IsSpanSerializerWrite]
    public static void Write(this ref Span<byte> ___span, ref int ___offset, ClientConnectionId value)
    {
        ...
        PrimitivesSpanSerializer.WriteInt64(ref ___span, ref ___offset, value.Value);
    }

    [IsSpanSerializerRead]
    public static ClientConnectionId ReadClientConnectionId(this ReadOnlySpan<byte> ___span, ref int ___offset)
    {
        ...
        return new ClientConnectionId(PrimitivesSpanSerializer.ReadInt64(___span, ref ___offset));
    }

    [IsSpanSerializerLength]
    public static int Length(ref int ___offset, ClientConnectionId value)
    {
        ___offset += 10;
        PrimitivesSpanSerializer.LengthInt64(ref ___offset, value.Value);
        return ___offset;
    }
}