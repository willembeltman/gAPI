...
public static class FabricConnectionIdSpanSerializer
{
    ...
    public static void Write(this ref Span<byte> ___span, ref int ___offset, FabricConnectionId value)
    {
    ...
    public static FabricConnectionId ReadFabricConnectionId(this ReadOnlySpan<byte> ___span, ref int ___offset)
    {
        ...
        return new FabricConnectionId(PrimitivesSpanSerializer.ReadInt64(___span, ref ___offset));
    }

    [IsSpanSerializerLength]
    public static int Length(ref int ___offset, FabricConnectionId value)
    {
        ___offset += 10;
