...
public static class SendRequestExceptionDtoSerializer
{
    ...
    [IsSerializerWrite]
    public static void Write(this BinaryWriter ___writer, SendRequestExceptionDto value)
    {
    ...
    [IsSerializerRead]
    public static SendRequestExceptionDto ReadSendRequestExceptionDto(this BinaryReader ___reader)
    {
