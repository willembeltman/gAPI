...
public static class UnsubscribeDtoSerializer
{
    ...
    [IsSerializerWrite]
    public static void Write(this BinaryWriter ___writer, UnsubscribeDto value)
    {
    ...
    [IsSerializerRead]
    public static UnsubscribeDto ReadUnsubscribeDto(this BinaryReader ___reader)
    {
        ...
        return new UnsubscribeDto(ServiceIdSerializer.ReadServiceId(___reader), UserIdSerializer.ReadUserId(___reader), SessionIdSerializer.ReadSessionId(___reader));
    }
}