...
public static class InvokeRequestDoneClientDtoComparer
{
    [IsComparer]
    public static bool IsDifferent(this InvokeRequestDoneClientDto value, InvokeRequestDoneClientDto otherValue)
    {
