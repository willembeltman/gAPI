...
public static class UserIdSerializer
{
    ...
    [IsSerializerWrite]
    public static void Write(this BinaryWriter ___writer, UserId value)
    {
    ...
    [IsSerializerRead]
    public static UserId ReadUserId(this BinaryReader ___reader)
    {
        ...
        return new UserId(___reader.ReadBoolean() == false ? null : ___reader.ReadString());
    }
}