...
public static class GetSessionCookieDataDtoSpanSerializer
{
    ...
    public static void Write(this ref Span<byte> ___span, ref int ___offset, GetSessionCookieDataDto value)
    {
    ...
    public static GetSessionCookieDataDto ReadGetSessionCookieDataDto(this ReadOnlySpan<byte> ___span, ref int ___offset)
    {
        ...
        return new GetSessionCookieDataDto(SessionIdSpanSerializer.ReadSessionId(___span, ref ___offset));
    }

    [IsSpanSerializerLength]
    public static int Length(ref int ___offset, GetSessionCookieDataDto value)
    {
        ___offset += 10;
