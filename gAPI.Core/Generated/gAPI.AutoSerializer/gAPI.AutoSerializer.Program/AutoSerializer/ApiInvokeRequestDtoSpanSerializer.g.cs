...
public static class ApiInvokeRequestDtoSpanSerializer
{
    public const ushort Magic = (ushort)0x4741;
    public const uint TypeId = 0xB23C8D4D;
    public const uint SchemaHash = 0xE6DEB1F3;

    [IsSpanSerializerWrite]
    public static void Write(this ref Span<byte> ___span, ref int ___offset, ApiInvokeRequestDto value)
    {
    ...
    public static ApiInvokeRequestDto ReadApiInvokeRequestDto(this ReadOnlySpan<byte> ___span, ref int ___offset)
    {
        ...
        var value = new ApiInvokeRequestDto();
    ...
    public static int Length(ref int ___offset, ApiInvokeRequestDto value)
    {
        ___offset += 10;
