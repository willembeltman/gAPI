...
public static class SynchronizeFabricIdsDtoSpanSerializer
{
    ...
    public static void Write(this ref Span<byte> ___span, ref int ___offset, SynchronizeFabricIdsDto value)
    {
    ...
    public static SynchronizeFabricIdsDto ReadSynchronizeFabricIdsDto(this ReadOnlySpan<byte> ___span, ref int ___offset)
    {
    ...
    public static int Length(ref int ___offset, SynchronizeFabricIdsDto value)
    {
        ___offset += 10;
