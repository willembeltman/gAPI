...
public static class ClientConnectionIdSerializer
{
    ...
    [IsSerializerWrite]
    public static void Write(this BinaryWriter ___writer, ClientConnectionId value)
    {
    ...
    [IsSerializerRead]
    public static ClientConnectionId ReadClientConnectionId(this BinaryReader ___reader)
    {
        ...
        return new ClientConnectionId(___reader.ReadInt64());
    }
}