...
public static class ApiInvokeResponseDtoSerializer
{
    ...
    [IsSerializerWrite]
    public static void Write(this BinaryWriter ___writer, ApiInvokeResponseDto value)
    {
    ...
    [IsSerializerRead]
    public static ApiInvokeResponseDto ReadApiInvokeResponseDto(this BinaryReader ___reader)
    {
        ...
        value.SessionData = ___reader.ReadString();
