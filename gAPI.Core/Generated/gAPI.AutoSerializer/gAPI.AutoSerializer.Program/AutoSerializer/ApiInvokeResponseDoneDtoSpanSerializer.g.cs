...
public static class ApiInvokeResponseDoneDtoSpanSerializer
{
    public const ushort Magic = (ushort)0x4741;
    public const uint TypeId = 0x36601789;
    public const uint SchemaHash = 0xADE42A53;

    [IsSpanSerializerWrite]
    public static void Write(this ref Span<byte> ___span, ref int ___offset, ApiInvokeResponseDoneDto value)
    {
        ...
        PrimitivesSpanSerializer.WriteBoolean(ref ___span, ref ___offset, value.SessionData != null);
        if (value.SessionData != null)
            PrimitivesSpanSerializer.WriteString(ref ___span, ref ___offset, value.SessionData);
    ...
    public static ApiInvokeResponseDoneDto ReadApiInvokeResponseDoneDto(this ReadOnlySpan<byte> ___span, ref int ___offset)
    {
        ...
        var value = new ApiInvokeResponseDoneDto();
        ...
        value.SessionData = PrimitivesSpanSerializer.ReadBoolean(___span, ref ___offset) == false ? null : PrimitivesSpanSerializer.ReadString(___span, ref ___offset);
    ...
    public static int Length(ref int ___offset, ApiInvokeResponseDoneDto value)
    {
        ___offset += 10;
        ...
        PrimitivesSpanSerializer.LengthBoolean(ref ___offset, value.SessionData != null);
        if (value.SessionData != null)
            PrimitivesSpanSerializer.LengthString(ref ___offset, value.SessionData);
