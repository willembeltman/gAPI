...
public static class FabricManagerIdSpanSerializer
{
    ...
    public static void Write(this ref Span<byte> ___span, ref int ___offset, FabricManagerId value)
    {
    ...
    public static FabricManagerId ReadFabricManagerId(this ReadOnlySpan<byte> ___span, ref int ___offset)
    {
        ...
        return new FabricManagerId(PrimitivesSpanSerializer.ReadString(___span, ref ___offset));
    }

    [IsSpanSerializerLength]
    public static int Length(ref int ___offset, FabricManagerId value)
    {
        ___offset += 10;
