...
public static class SendArgumentedRequestDoneDtoSpanSerializer
{
    public const ushort Magic = (ushort)0x4741;
    public const uint TypeId = 0x684A07A7;
    public const uint SchemaHash = 0xA98FCB25;

    [IsSpanSerializerWrite]
    public static void Write(this ref Span<byte> ___span, ref int ___offset, SendArgumentedRequestDoneDto value)
    {
    ...
    public static SendArgumentedRequestDoneDto ReadSendArgumentedRequestDoneDto(this ReadOnlySpan<byte> ___span, ref int ___offset)
    {
        ...
        var value = new SendArgumentedRequestDoneDto();
        value.RequestId = RequestIdSpanSerializer.ReadRequestId(___span, ref ___offset);
        return value;
    }

    [IsSpanSerializerLength]
    public static int Length(ref int ___offset, SendArgumentedRequestDoneDto value)
    {
        ___offset += 10;
