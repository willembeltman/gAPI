...
public static class SendRequestCancelledClientDtoSpanSerializer
{
    ...
    public static void Write(this ref Span<byte> ___span, ref int ___offset, SendRequestCancelledClientDto value)
    {
    ...
    public static SendRequestCancelledClientDto ReadSendRequestCancelledClientDto(this ReadOnlySpan<byte> ___span, ref int ___offset)
    {
