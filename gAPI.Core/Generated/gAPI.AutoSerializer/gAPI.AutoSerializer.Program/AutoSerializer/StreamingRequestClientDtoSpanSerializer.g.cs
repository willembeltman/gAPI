...
public static class StreamingRequestClientDtoSpanSerializer
{
    ...
    public static StreamingRequestClientDto ReadStreamingRequestClientDto(this ReadOnlySpan<byte> ___span, ref int ___offset)
    {
        ...
        return new StreamingRequestClientDto(RoutingDtoSpanSerializer.ReadRoutingDto(___span, ref ___offset), PrimitivesSpanSerializer.ReadInt32(___span, ref ___offset), StreamIdSpanSerializer.ReadStreamId(___span, ref ___offset), PrimitivesSpanSerializer.ReadBoolean(___span, ref ___offset), PrimitivesSpanSerializer.ReadBoolean(___span, ref ___offset) == false ? null : PrimitivesSpanSerializer.ReadString(___span, ref ___offset));
    }

    [IsSpanSerializerLength]
    public static int Length(ref int ___offset, StreamingRequestClientDto value)
    {
        ___offset += 10;
