...
public static class AuthStateUserDtoSpanSerializer
{
    ...
    public static AuthStateUserDto ReadAuthStateUserDto(this ReadOnlySpan<byte> ___span, ref int ___offset)
    {
    ...
    public static int Length(ref int ___offset, AuthStateUserDto value)
    {
        ___offset += 10;
