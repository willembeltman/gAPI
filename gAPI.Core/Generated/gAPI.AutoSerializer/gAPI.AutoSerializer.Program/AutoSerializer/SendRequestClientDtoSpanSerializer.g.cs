...
public static class SendRequestClientDtoSpanSerializer
{
    ...
    public static SendRequestClientDto ReadSendRequestClientDto(this ReadOnlySpan<byte> ___span, ref int ___offset)
    {
    ...
    public static int Length(ref int ___offset, SendRequestClientDto value)
    {
        ___offset += 10;
