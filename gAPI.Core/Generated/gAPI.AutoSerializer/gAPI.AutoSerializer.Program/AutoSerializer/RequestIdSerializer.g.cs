...
public static class RequestIdSerializer
{
    ...
    [IsSerializerWrite]
    public static void Write(this BinaryWriter ___writer, RequestId value)
    {
    ...
    [IsSerializerRead]
    public static RequestId ReadRequestId(this BinaryReader ___reader)
    {
        ...
        return new RequestId(___reader.ReadString());
    }
}